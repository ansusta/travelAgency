...
public class PartenariatPanel extends JPanel {
    ...
    private final Color ACTIVE_COLOR = new Color(40, 180, 100);
    private final Color INACTIVE_COLOR = new Color(220, 80, 70);
    ...
    private JPanel createHeader() {
        ...
        // Title
        JLabel title = new JLabel("  GESTION DES PARTENARIATS");
    ...
    private JPanel createForm() {
        ...
        // Form Title
        JLabel formTitle = new JLabel("Informations Partenaire");
        ...
        String[] fields = {"Nom Partenaire:", "Prénom:", "Num Tél:"};
        for(String field : fields) {
            panel.add(createField(field));
        }

        // Status Toggle with modern styling
        ...
        JToggleButton statusToggle = new JToggleButton("ACTIF");
        statusToggle.setFont(BUTTON_FONT);
        statusToggle.setForeground(Color.WHITE);
        statusToggle.setBackground(ACTIVE_COLOR);
        statusToggle.setFocusPainted(false);
        statusToggle.setBorderPainted(false);
        statusToggle.setCursor(new Cursor(Cursor.HAND_CURSOR));
        statusToggle.setPreferredSize(new Dimension(100, 35));
        
        statusToggle.addActionListener(e -> {
            if (statusToggle.isSelected()) {
                statusToggle.setText("ACTIF");
                statusToggle.setBackground(ACTIVE_COLOR);
            } else {
                statusToggle.setText("INACTIF");
                statusToggle.setBackground(INACTIVE_COLOR);
            }
        });
        
        statusPanel.add(statusLabel, BorderLayout.NORTH);
        statusPanel.add(statusToggle, BorderLayout.CENTER);
    ...
    private JPanel createTable() {
        ...
        JLabel tableTitle = new JLabel("Liste des Partenaires");
        ...
        String[] cols = {"ID", "Nom", "Prénom", "Téléphone", "Status"};
        Object[][] data = {
            {"1", "Air France", "Représentant", "0555 111 111", "Actif"},
            {"2", "Hilton", "Manager", "0555 222 222", "Actif"},
            {"3", "Europcar", "Responsable", "0555 333 333", "Inactif"}
        };
