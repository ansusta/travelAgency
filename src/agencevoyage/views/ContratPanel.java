...
public class ContratPanel extends JPanel {
    private final Color PRIMARY_COLOR = new Color(30, 100, 200); // Your original darker blue
    ...
    private JPanel createHeader() {
        ...
        // Title
        JLabel title = new JLabel("  GESTION DES CONTRATS");
    ...
    private JPanel createForm() {
        ...
        // Form Title
        JLabel formTitle = new JLabel("Nouveau Contrat");
        ...
        // Type de Contrat
        panel.add(createField("Type de Contrat:"));
        ...
        dateLabel.setFont(new Font("Segoe UI Semibold", Font.BOLD, 13));
        ...
        datePicker.getComponentDateTextField().setBackground(new Color(250, 252, 255));
        
        datePanel.add(dateLabel, BorderLayout.NORTH);
        datePanel.add(datePicker, BorderLayout.CENTER);
        datePanel.add(Box.createRigidArea(new Dimension(0, 12)), BorderLayout.SOUTH);
        panel.add(datePanel);
        ...
        JLabel descLabel = new JLabel("Description / Clauses:");
        descLabel.setFont(new Font("Segoe UI Semibold", Font.BOLD, 13));
        descLabel.setForeground(new Color(70, 70, 70));
        
        JTextArea desc = new JTextArea(4, 20);
        desc.setFont(MAIN_FONT);
        ...
        desc.setBackground(new Color(250, 252, 255));
        
        descPanel.add(descLabel, BorderLayout.NORTH);
        descPanel.add(new JScrollPane(desc), BorderLayout.CENTER);
        descPanel.add(Box.createRigidArea(new Dimension(0, 12)), BorderLayout.SOUTH);
        panel.add(descPanel);
        
        // ID Paiement (FK)
        panel.add(createField("ID Paiement (FK):"));
        
        // ID Employé (FK)
        panel.add(createField("ID Employé (FK):"));
    ...
    private JPanel createTable() {
        ...
        JLabel tableTitle = new JLabel("Contrats Existants");
        ...
        String[] cols = {"ID", "Date", "Type", "ID Paiement", "ID Employé"};
        Object[][] data = {
            {"1", "2024-01-15", "Standard", "101", "5"},
            {"2", "2024-02-20", "Premium", "102", "3"},
            {"3", "2024-03-05", "Gold", "103", "7"}
        };
