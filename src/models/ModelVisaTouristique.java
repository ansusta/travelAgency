...
import java.sql.Statement; // This is the one you asked for
public class ModelVisaTouristique extends ModelVisa {
    public ModelVisaTouristique(Integer idTraitement, Date dateT, String Obs,String client , 
    ...
    public ModelVisaTouristique(Date dateT, String Obs,String client ,
                                String partenariat, String employe, String etat, Double prix, String pays) {
 ...
 public static void addVisaTouristique(ModelVisa data) throws SQLException {
        Connection connection = DataBaseConnection.getConnection();
        ...
        String sqlVisaTouristique = "INSERT INTO visa_touristique (idVisa) VALUES (?)";
    ...
    switch (uiEtat) {
        ...
        public static void deleteVisaTouristique(Integer id) throws SQLException {
    Connection connection = DataBaseConnection.getConnection();

    String sql1 = "DELETE FROM visa_touristique WHERE idVisa = ?";
